-- Drop and recreate submit_order with special_order support.
-- The existing deployed version uses column names: retail_unit_price, retail_line_total
-- (NOT retail_price / retail_line_total / retail_mode which the prior migration
-- files reference). This matches what's actually live.
...
begin
  ...
  loop
    ...
    insert into public.order_items (
      ...
      retail_unit_price, retail_line_total,
      special_order
    ) values (
      v_order_id,
      v_item->>'plant_key',
      ...
      (v_item->>'retail_unit_price')::numeric,
